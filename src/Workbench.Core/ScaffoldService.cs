...
public static class ScaffoldService
{
    ...
    public static ScaffoldResult Scaffold(string repoRoot, bool force)
    {
        ...
        WriteFile(Path.Combine(config.Paths.SpecsRoot, "requirements", "README.md"),
            "# Requirements\n\nCanonical requirement specifications live here under domain folders.\n");
    ...
    private static string BuildSpecsReadmeTemplate()
    {
        return string.Join(
            ...
            "## Layout",
            string.Empty,
            "- `specs/requirements`: requirement specifications grouped by domain.",
