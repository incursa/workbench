...
- Decide whether any additional canonical work-item refinements are needed.
- Add hooks installer (pre-commit/pre-push) or CI helper for validation.

## Documentation
- Add doc templates for specifications, architecture, work items, and
  verification artifacts with consistent sections.
