...
workbench:
  ...
  codeRefs: []
  pathHistory:
    - "C:/contracts/commands.md"
  path: /contracts/commands.md
owner: platform
status: active
updated: 2025-12-27
---
...
Machine-readable command output details remain documented in `contracts/commands.md`.
...
- `workbench`
  - `workbench board`: Group: workboard commands.
    - `workbench board regen`: Regenerate only the workboard section in work/README.md.
  ...
  - `workbench doc`: Group: documentation commands.
    ...
    - `workbench doc regen-help`: Regenerate contracts/commands.md from the live command tree.
  ...
  - `workbench item`: Group: work item commands.
    - `workbench item close`: Set status to done and move to work/done.
    ...
    - `workbench item new`: Create a new work item in work/items using templates and ID allocation.
...
Subcommands:
- `regen`: Regenerate only the workboard section in work/README.md.

### `workbench board regen`
Regenerate only the workboard section in work/README.md.
...
- `regen-help`: Regenerate contracts/commands.md from the live command tree.
...
Options:
- `--type <type>` (required): Doc type: specification, architecture, guide, work_item, doc
- `--path <path>` (required): Doc path, link, or artifact ID.
...
- `--artifact-id <artifact-id>`: Artifact identifier for canonical specs, architecture docs, and work items.
...
Regenerate contracts/commands.md from the live command tree.

Options:
- `--check`: Fail if contracts/commands.md is out of date.
- `--path <path>`: Output path (defaults to contracts/commands.md).
...
Subcommands:
- `close`: Set status to done and move to work/done.
...
- `new`: Create a new work item in work/items using templates and ID allocation.
...
Set status to done and move to work/done.

Arguments:
- `id`: Work item ID.

Options:
- `--no-move`: Do not move the item to work/done.
...
- `--include-done`: Include items from work/done.
...
Options:
- `--include-done`: Include work/done items.
- `--dry-run`: Report changes without writing files.
...
- `--workboard`: Regenerate the workboard section in work/README.md.
