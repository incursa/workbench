...
workbench:
  ...
  codeRefs: []
  pathHistory:
    - "C:/contracts/cli-help.md"
  path: /contracts/cli-help.md
owner: platform
status: active
updated: 2025-12-27
---
...
Machine-readable command output contracts remain documented in `contracts/commands.md`.
...
- `workbench`
  ...
  - `workbench doc`: Group: documentation commands.
    ...
    - `workbench doc regen-help`: Regenerate contracts/cli-help.md from the live command tree.
...
- `regen-help`: Regenerate contracts/cli-help.md from the live command tree.
...
Regenerate contracts/cli-help.md from the live command tree.

Options:
- `--check`: Fail if contracts/cli-help.md is out of date.
- `--path <path>`: Output path (defaults to contracts/cli-help.md).
