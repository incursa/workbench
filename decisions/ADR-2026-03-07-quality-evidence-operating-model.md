...
workbench:
  ...
  codeRefs: []
  pathHistory:
    - "C:/decisions/ADR-2026-03-07-quality-evidence-operating-model.md"
  path: /decisions/ADR-2026-03-07-quality-evidence-operating-model.md
owner: platform
status: proposed
updated: 2026-03-07
---
...
- authored testing intent remains under `contracts/`
...
The existing `contracts/test-gate.contract.yaml` is the compatibility
...
- [Quality Evidence Model (Testing V1)](/contracts/quality-evidence-model.md)
