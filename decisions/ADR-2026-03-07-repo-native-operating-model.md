...
workbench:
  ...
  codeRefs: []
  pathHistory:
    - "C:/decisions/ADR-2026-03-07-repo-native-operating-model.md"
  path: /decisions/ADR-2026-03-07-repo-native-operating-model.md
owner: platform
status: accepted
updated: 2026-03-07
---
...
- Markdown docs under `overview/`, `contracts/`, `decisions/`, `runbooks/`, `tracking/`, `templates/`, `specs/`, and `architecture/`
