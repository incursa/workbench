...
workbench:
  ...
  codeRefs: []
  pathHistory:
    - "C:/overview/documentation-structure.md"
  path: /overview/documentation-structure.md
owner: platform
status: active
updated: 2026-03-20
---
...
## Purpose
This overview describes how the documentation is organized, who each category serves, and where new material should live. It aligns with the repo standard in [Specification and traceability standard](/overview/specification-and-traceability-standard.md) and clarifies the intent of the canonical `overview/`, `specs/`, `architecture/`, `contracts/`, `decisions/`, `runbooks/`, `tracking/`, `templates/`, and `work/` roots.

## Quick lookup: doc types and canonical paths

| Doc type | Canonical path | Intended audience | Belongs here (examples) |
| --- | --- | --- | --- |
| Overview | `/overview/` | Everyone | Vision, scope, and cross-cutting standards (e.g., [specification-and-traceability-standard](/overview/specification-and-traceability-standard.md)). |
| Product | `/overview/product.md` | Product, design, engineering | Feature specs, requirements, user journeys, and product notes (see [Product README](/overview/product.md)). |
...
| Contracts | `/contracts/` | Engineering, integrators | Schemas, CLI/API contracts, interface docs (see [Contracts README](/contracts/README.md)). |
| Decisions | `/decisions/` | Engineering, stakeholders | ADRs and tradeoff history (see [Decisions README](/decisions/README.md)). |
| Runbooks | `/runbooks/` | Ops, support, on-call | Operational procedures, troubleshooting, releases (see [Runbooks README](/runbooks/README.md)). |
| Tracking | `/tracking/` | Delivery, leadership | Milestones, progress notes, delivery status (see [Tracking README](/tracking/README.md)). |
| Templates | `/templates/` | Authors | Reusable doc templates for specs, architecture, ADRs, contracts, and runbooks. |
...
**Purpose:** High-level summaries, the documentation map, and foundational standards that describe how Workbench documentation is organized. The canonical repo standard lives in [specification-and-traceability-standard](/overview/specification-and-traceability-standard.md).
...
**Purpose:** User-facing requirements and feature-level behavior. Requirement specs live under [specs](/specs/README.md), and the category is anchored by [Product README](/overview/product.md).
...
**Purpose:** Interface definitions and machine-readable contracts. The [Contracts README](/contracts/README.md) lists current schema artifacts.
...
**Purpose:** The history of architectural decisions, tradeoffs, and rationale. See [Decisions README](/decisions/README.md).
...
**Purpose:** Operational guidance and step-by-step procedures. See [Runbooks README](/runbooks/README.md).
...
**Purpose:** Progress tracking, milestones, and delivery notes. See [Tracking README](/tracking/README.md).
...
- Move archived docs to `/tracking/archived/` and add a short note in the
...
related:
  specs:
    - /overview/documentation-structure.md
---
```
