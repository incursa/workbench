...
Machine-readable command output details remain documented in `docs/commands.md`.
...
- `workbench`
  ...
  - `workbench doc`: Group: documentation commands.
    ...
    - `workbench doc regen-help`: Regenerate docs/commands.md from the live command tree.
...
- `regen-help`: Regenerate docs/commands.md from the live command tree.
...
Regenerate docs/commands.md from the live command tree.

Options:
- `--check`: Fail if docs/commands.md is out of date.
- `--path <path>`: Output path (defaults to docs/commands.md).
