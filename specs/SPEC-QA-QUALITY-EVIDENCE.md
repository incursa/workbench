...
Trace:
- Implemented By:
  - [TASK-0016](/work/items/TASK-0016-add-normalized-test-inventory-discovery-and-schema.md)
  - [TASK-0017](/work/items/TASK-0017-add-trx-ingestion-and-test-run-summary-contract.md)
  - [TASK-0018](/work/items/TASK-0018-add-cobertura-ingestion-and-coverage-summary-contract.md)
