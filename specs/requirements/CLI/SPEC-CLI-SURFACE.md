...
The CLI help output and [`specs/generated/commands.md`](../../generated/commands.md) MUST stay synchronized with the
...
- [`SPEC-CLI-ONBOARDING`](SPEC-CLI-ONBOARDING.md) remains the dedicated spec for first-run setup and the
  `guide` entrypoint.
- [`WI-WB-0024`](../../work-items/WB/WI-WB-0024-author-cli-command-specifications-for-all-exposed-commands.md) tracks the broader command-spec authoring work.
