...
| Proof health | `dotnet tool run workbench quality proof-health` | Classifies selected requirements by authored coverage contract, discovered requirement test traits, direct test refs, and gap-ledger blockers. |
